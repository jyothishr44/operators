...
39
'''
nobs = int(input("No of No Balls:"))
wides = int(input("No of No Wide Balls:"))
byes = int(input("No of Byes:"))
leg_byes = int(input("No of Leg Byes:"))
penalty_runs = int(input("Penalty Runs:"))
total_extras = nobs+wides+byes+leg_byes+penalty_runs
print(total_extras)
